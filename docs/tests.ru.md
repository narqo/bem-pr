...
- [Абстрактные знания](#абстрактные-знания)
- [Варианты оформления тестов](#варианты-оформления-тестов)
	- [Тесты, не требующие специфичного DOM-дерева](#тесты-не-требующие-специфичного-dom-дерева)
	- [Тесты, требующие специфичное DOM-дерево](#тесты-требующие-специфичное-dom-дерево)
- [Оформление файла `block.test.js`](#оформление-файла-blocktestjs)
- [Оформление файла `block.tests/testbundle.bemjson.js`](#оформление-файла-blockteststestbundlebemjsonjs)
- [Оформление элемента `i-bem__test`](#оформление-элемента-i-bem__test)
- [Настройки](#настройки)
	- [Расширяем класс TestNode](#расширяем-класс-testnode)
	- [Настраиваем сборку `_testbundle.test.js`](#настраиваем-сборку-_testbundletestjs)
	- [Добавляем в проект модуль технологии `tests.js`](#добавляем-в-проект-модуль-технологии-testsjs)
	- [Добавляем путь до технологии `tests.js` в конфиги уровней `*.sets`](#добавляем-путь-до-технологии-testsjs-в-конфиги-уровней-sets)
	- [Указываем пути до технологий `test.js`, `test-tmpl` и `phantom.js`](#указываем-пути-до-технологий-testjs-test-tmpl-и-phantomjs)
- [Сборка и запуск тетов](#сборка-и-запуск-тетов)
